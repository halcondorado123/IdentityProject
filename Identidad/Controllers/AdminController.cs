...
namespace Identidad.Controllers
{
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(PersonaME personaME, Usuario usuario)
        {
            if (ModelState.IsValid)
            {
                ...
                var appUsuario = new AppUsuario
                {
                    ...
                    Estatus = personaME.Estatus,
                    TipoDocumento = personaME.TipoDocumento,
                    NumeroDocumento = personaME.NumeroDocumento,
                    LugarExpedición = personaME.LugarExpedición,
                    RH = personaME.RH,
                    Nombres = personaME.Nombres,
                    Apellidos = personaME.Apellidos,
                    FechaNacimiento = personaME.FechaNacimiento,
                    FechaExpedicion = personaME.FechaExpedicion,
                    FechaVencimiento = personaME.FechaVencimiento,
                    Edad = personaME.Edad,
                    LugarNacimiento = new LugarNacimientoME
                    {
                        Pais = personaME.LugarNacimiento?.Pais,
                        Departamento = personaME.LugarNacimiento?.Departamento,
                        Municipio = personaME.LugarNacimiento?.Municipio
                    },
                    Domicilio = new DomicilioME
                    {
                        Pais = personaME.LugarNacimiento?.Pais,
                        Departamento = personaME.LugarNacimiento?.Departamento,
                        Municipio = personaME.LugarNacimiento?.Municipio
